...
public class SubscriptionCheckTask implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        delegateExecution.setVariable("isActiveSubscription", magazine.getSubscriptions().contains(applicationUser));
